...
export const mineVein: Skill = {
  name: "mine_vein",
  description: "Mine a vein of ORE (iron/coal/diamond/etc) — NOT wood. Pass { ore: 'iron_ore' } or it uses what the player is looking at. For WOOD use chop_tree; to dig down for stone use mine_down.",
  run: mineVeinBody,
};
